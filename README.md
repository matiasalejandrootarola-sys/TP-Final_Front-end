...
Actualización del 21/11/2025

Al trabajo ya mencionado anteriormmente, se le adjunta un archivo .js (junto con un archivo .json) que permite la creación del código de la tarjeta "Producto", proporcionando 3 tarjetas (como se diseño originalmente), las cuales permiten navegar hacia otro HTML de “Reseñas”, donde se puede encontrar posibles acotaciones de diferentes compradores.
También se corrigieron diferentes errores y redundancias en todo el projecto con la ayuda de la herramientas de AI.
